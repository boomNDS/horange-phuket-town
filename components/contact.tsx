      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative order-1 min-h-[360px] sm:min-h-[480px] md:min-h-[600px] flex items-center justify-center px-4 sm:px-10 py-12 sm:py-24 overflow-hidden">
          ...
          <FadeIn
            ...
            direction="up"
          >
            <h2 className="font-display text-3xl sm:text-5xl md:text-6xl mb-4 sm:mb-8">
              Contact us
            </h2>
            <div className="space-y-3 sm:space-y-6 text-sm sm:text-lg">
              ...
              <p>
                <a
                  ...
                  className="hover:text-copper transition-colors underline break-all"
                >
                  {contact.email}
                </a>
              </p>
              <div className="flex gap-3 sm:gap-6 pt-2 sm:pt-4">
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <FadeIn
                      ...
                      className="flex size-11 items-center justify-center rounded-full bg-white/20 text-white transition-all hover:bg-copper"
        ...
        <FadeIn
          as="div"
          className="order-2 min-h-[300px] md:min-h-[600px] bg-muted-foreground/10"
          direction="up"
          delay={150}
        >
          <iframe
